...
test('release-facing version metadata stays aligned', () => {
  ...
  const exact = [
    ...
    ['desktop/sage-shell/src/control.rs', 'matches!(minor, Some(10..=22))'],
    ['scripts/stage-native-shell-daemon.sh', 'through v11.22.x semver'],
    ...
    ['docs/UPGRADING.md', `| v${version} | App-v28 rides as a compiled, dormant gate`],
